    ...
    const carousels = {
      ...
      '#carouselWeb': {
        texts: [
          ...
          'Proyecto CG: <br>Página web institucional con HTML, CSS y JS.<br><br>Clickea en la imagen para ver su código.<br>              <a href="https://micaelaedith.github.io/proyecto-gc/" target="_blank">Link a la página.</a>'
        ],
        textId: 'webText'
      },
      '#carouselGame': {
